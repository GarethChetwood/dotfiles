# Generated by Powerlevel10k configuration wizard on 2020-03-31 at 18:55 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    caps_user               # capitalised user name
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#fff'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=3
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#333'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='magenta'
  ...
  ################################[ battery: internal battery ]#################################
  # Only show battery when above this threshold
  ...
  function prompt_wifi_signal2(){
    local signalRaw=$(/System/Library/PrivateFrameworks/Apple*.framework/Versions/Current/Resources/airport -I | grep CtlRSSI | sed -e 's/^.*://g' | xargs -I SIGNAL printf “SIGNAL”)
    local signal="${signalRaw//[^0-9.]/}"
    local color='#FF0'
    [[ $signal -gt 75 ]] && color='#0F0'
    [[ $signal -lt 50 ]] && color='#F00'
    #p10k segment -f $color -i '⭐' -t "${signal}" # \uf230 is 
    p10k segment -b $color -f '#FFF' -i '⭐' -t "${signal}" # \uf230 is 
  }
  ...
  function prompt_wifi_signal(){
	...
	local out=""
		...
		local strength=$(echo $output | grep 'CtlRSSI' | awk -F': ' '{print $2}')
                local color='%F{yellow}'

                [[ $speed -gt 100 ]] && color='%F{green}'
                [[ $speed -lt 50 ]] && color='%F{red}'

                 #out="%{$color%}$ssid $speed Mb/s%{%f%}" # removed char not in my PowerLine font 
                 out="%{$color%}${strength//[^0-9.]/}%%"
        fi
	p10k segment -f "yellow" -b "blue" -i "📶" -t "$out"
  }

  #POWERLEVEL9K_CUSTOM_WIFI_SIGNAL="zsh_wifi_signal"

  function prompt_caps_user(){
    local upperUser=$USER
    #p10k segment -b '#000'  -f '#FFF' -t ${(C)upperUser}
    p10k segment -f '#FFF' -t ${(C)upperUser}
  }

  #POWERLEVEL9K_CUSTOM_CAPS_USER="zsh_caps_user"
