...
function obj:_showContextMenu(row)
  ...
  local menuTable = {
       { title = "Paste all with delimiter", fn = hs.fnutils.partial(self.pasteAllWithDelimiter, self, row, "\t") },
       { title = "Paste all with line breaks", fn = hs.fnutils.partial(self.pasteAllWithDelimiter, self, row, "\n") },
       { title = "-" },
